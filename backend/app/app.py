...
from app.routes import user_route,post_route,like_route,comment_route,bookmark_route,follower_route
...
app.include_router(comment_route.router, prefix=settings.API_PREFIX)
app.include_router(bookmark_route.router, prefix=settings.API_PREFIX)
app.include_router(follower_route.router, prefix=settings.API_PREFIX)
